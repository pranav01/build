...
$(info   RADIUM_VERSION=$(RADIUM_VERSION))
...
ifdef BASIC_OPTIMIZATIONS
$(info   BASIC_OPTIMIZATIONS=$(BASIC_OPTIMIZATIONS))
else
$(info   BASIC_OPTIMIZATIONS=false)
endif
...
ifeq (true,$(GRAPHITE_OPTI))
$(info   GRAPHITE_OPTI=$(GRAPHITE_OPTI))
else
$(info   GRAPHITE_OPTI=false)
endif
...
ifdef KRAIT_OPTIMIZATIONS
$(info   KRAIT_OPTIMIZATIONS=$(KRAIT_OPTIMIZATIONS))
else
